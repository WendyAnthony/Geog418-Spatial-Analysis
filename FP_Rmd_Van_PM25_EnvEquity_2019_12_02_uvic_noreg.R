...
## ----Create_raster_map_PM25_variance_png---------------------------------
...
## ----Create_raster_map_PM25_CI_png---------------------------------------
png("KO_PM25_CI_f0_Exp.png")
KO_PM25_CI_f0_Exp
dev.off()


## ----Perform_KO_krige_interpolation_2------------------------------------
dat.krg <- krige( f.0, spSample, grd, dat.fit)


## ----Convert_KO_kriged_surface_raster_object_2---------------------------
r <- raster(dat.krg)
...
## Uncomment code to run after document knits successfully
 #library(knitr)
 #purl("FP_Rmd_Van_PM25_EnvEquity_2019_12_02_uvic_noreg.Rmd")
